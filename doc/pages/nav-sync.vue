<template>
  <v-container>
    ...
    <p class="my-4">
      This examples reflects all query parameters exactly as they are from parent to frame and the contrary. It uses the <code>sync-params</code> attribute.
    </p>
    <d-frame
    ...
    <p class="my-4">
      This examples reflects query parameters and adds a different prefix for both frames. It uses <code>sync-params="*:child1_"</code> and <code>sync-params="*:child2_"</code> attributes.
    </p>
    <v-row>
      <v-col>
        <d-frame
